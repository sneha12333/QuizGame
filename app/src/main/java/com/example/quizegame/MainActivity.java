...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv_score, tv_questions, tv_timmer, tv_bottommessage;
    ...
    CountDownTimer timer = new CountDownTimer(30000, 1000) {
        ...
        public void onTick(long millisUntilFinised) {
            ...
            secondsRemaining--;
            tv_timmer.setText(Integer.toString(secondsRemaining) + "sec");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_timmer = findViewById(R.id.tv_timer);

        prog_timer = findViewById(R.id.prog_timer);

        tv_timmer.setText("0Sec");
